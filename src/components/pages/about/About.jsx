    ...
    <div className="">
      ...
      <div className="mission">
        ...
        <div className="mission-notes">
          ...
          <p>
            ...
            ipsum dolor
            <br /> sit amet consectetur adipisicing elit. Ab laudantium dolores
            cum. Saepe, facere iste! Ad quam deleniti laborum libero distinctio
            cum beatae. Amet quaerat veritatis inventore <br />
      ...
      <div className="wrapper">
        <div className="vision">
          ...
          <p>
            ...
            <br /> iste vel minus quaerat, qui quod odio! Eius, nulla. Eius quod
            ...
            <br /> Amet blanditiis eius dignissimos vitae Lorem ipsum dolor sit
            amet consectetur adipisicing elit.
            <br /> Eveniet, quo veritatis minima deleniti reiciendis nulla quam
            <br /> obcaecati sed, dolore laudantium esse fugiat tempora magnam,
            dolorem accusamus consequatur perferendis? Fugit <br />
            cumque dicta, molestias in autem illo necessitatibus praesentium
            amet,
            <br /> blanditiis eius aperiam repudiandae, fugiat excepturi
            numquam! Ea veniam nam ullam numquam!!
          </p>
        </div>
      ...
      <div className="core-values_1">
        <p>
          ...
          consectetur adipisicing elit. At rem, beatae <br />
          cumque ab facilis facere dolores dolorem ullam cum libero? Molestiae
          animi alias ullam asperiores.Amet blanditiis eius dignissimos vitae
          Lorem ipsum dolor sit amet consectetur adipisicing elit.
          <br /> Eveniet, quo veritatis minima deleniti reiciendis nulla
          ...
          <br /> blanditiis eius aperiam repudiandae, fugiat excepturi numquam!
